...
$string['choosereadme'] = 'Theme clean is a child theme of Boost.';
// Name of the settings pages.
$string['configtitle'] = 'Clean settings';
...
$string['login-background'] = 'Login page background image';
// Background image for login page.
$string['login-background_desc'] = 'An image that will be stretched to fill the background of the login page.';
